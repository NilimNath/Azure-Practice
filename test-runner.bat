...
set ProjectPath="C:\Users\Administrator\Documents\TestComplete 15 Projects\TestProject1\WebTesting\WebTesting.pjs"
...
"C:\Program Files (x86)\SmartBear\TestExecute 15\Bin\TestExecute.exe" %ProjectPath% /r /e /AccessKey:73e7dbca-782b-44d9-8f5a-ee8a297aaeb2 /SilentMode /Timeout:1200 /ns /ErrorLog:%cd%\logs\error.log /ExportLog:%cd%\logs\runlog.html /ExportSummary:%cd%\logs\runlog.xml /shr:%cd%\logs\shared-repo-link.txt /shrn:LogFromGitHubAction /shrei:7
